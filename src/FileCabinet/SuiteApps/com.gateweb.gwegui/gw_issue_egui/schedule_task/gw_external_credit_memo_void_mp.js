...
define(['./transactionDao/gw_credit_memo_dao',
	    ...
	    './utils/gw_map_utils',
		'N/record'], function(creditMemoDao, sellerDao, evidenceStatusDao, apDocTypeOptionDao, StatusEmun, mainDao, gwMapUtils, record) { 
    ...
    function getInputData(context) {
    	...
    	return creditMemoDao.getVoidTransactionIds();        
    }
