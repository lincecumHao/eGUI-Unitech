...
define(['./transactionDao/gw_cash_sales_dao',
	...
	var completedEvidenceStatusValue = StatusEmun.CASHSALES_OPEN_EXTERNAL_DOCUMENT.SUCCESS; //完成條件狀態	=>憑證已開立, 未進入關網系統
	var errorEvidenceStatusValue = StatusEmun.CASHSALES_OPEN_EXTERNAL_DOCUMENT.ERROR;
				...
				if (subsidiaryAry.length !=0) {
					...
					if (updateResult == true) {
						...
						if (voucherItemValues != null) {
							...
							completedEvidenceStatusValue = StatusEmun.CASHSALES_OPEN_EXTERNAL_DOCUMENT.SUCCESS;  
							defaultLocked = true;
