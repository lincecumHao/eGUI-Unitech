...
define(['./transactionDao/gw_cash_sales_dao',
	    ...
	    './utils/gw_map_utils',
		'N/record'], function(cashSalesDao, sellerDao, evidenceStatusDao, StatusEmun, mainDao, gwMapUtils, record) { 
	...
	var completedEvidenceStatusValue = StatusEmun.CASHSALES_VOID_EXTERNAL_DOCUMENT.SUCCESS; //完成條件狀態	=>憑證已開立, 未進入關網系統
	var errorEvidenceStatusValue =StatusEmun.CASHSALES_VOID_EXTERNAL_DOCUMENT.ERROR;
